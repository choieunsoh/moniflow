...
- make the repeat purchase cheap, and the keypad answer back
- answer a keypad press with a short pulse
- let a repeat purchase start from the row it repeats
...
- let the fill carry the selected state, not the border
- let the fill carry the selected state, not the border
...
- sign the share card's over-budget KPI tiles
- sign the share card's over-budget tiles instead of renaming them
...
- sign the share card, and lead its KPIs with today
- sign the share card, and lead its KPIs with today
